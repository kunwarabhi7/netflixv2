...
<Image alt='/' src='https://assets.nflxext.com/ffe/siteui/vlv3/5aecc44d-2a1f-4313-8399-98df20908b64/4d9d5abf-07d8-4dd6-9899-a96b902312ee/IN-en-20221114-popsignuptwoweeks-perspective_alpha_website_large.jpg' fill     />
        ...
        <div className='absolute bg-black/75  md:w-[450px] md:h-[600px] w-96 h-[32rem] ml-4 md:ml-0 left-0 md:left-[36rem] top-40  text-white'>
            <p className='ml-16  mt-8 md:text-3xl  text-white'>Sign In</p>
<form onSubmit={loginUserWithEmailPassword}>
            ...
            <button onClick={loginUserWithEmailPassword} className='bg-red-500 text-white font-bold rounded-xl w-80 h-12 md:-pt-8 -pt-16 ml-12 md:ml-16'>Sign In </button>
</form>
      <br/>
