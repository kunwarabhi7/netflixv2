...
<Image alt='/' src='https://assets.nflxext.com/ffe/siteui/vlv3/5aecc44d-2a1f-4313-8399-98df20908b64/4d9d5abf-07d8-4dd6-9899-a96b902312ee/IN-en-20221114-popsignuptwoweeks-perspective_alpha_website_large.jpg' layout='fill'     />
      ...
      <div className='absolute bg-black/75  md:w-[450px] md:h-[600px] w-16 h-32 left-0 md:left-[36rem] top-40  text-white'>
          ...
          <input value={username} type="text" placeholder='Email or phone number' className='mb-8 bg-gray-700 p-3 pr-8 mx-auto w-80 rounded-lg text-white' />
          <input value={password} type="password" placeholder='Password' className='mb-8 bg-gray-700 p-3 pr-8 text-white rounded-lg w-80 mx-auto' />
          </div>
          <button className='bg-red-500 text-white font-bold rounded-xl w-80 h-12 -pt-8 ml-16'>Sign Up </button>
    <br/>
